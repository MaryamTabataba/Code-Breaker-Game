...
var start = new Date();
var btn_initial_top;
var url = "http://indigo.eecs.yorku.ca:3000/post";   // "http://localhost:3000/post";
...
function createGameBoard(){
    ...
    for (var i = NUM_ATTEMPTS; i > 0; i--){
        ...
        // set its id and class. Hint: to set its class, 
		// you can write jQuery: $(newDiv).attr("class", "attempt")
		//or, regular JS:   newDiv.setAttribute("class", "attempt")
		//...
        //...
...
function response(data, status){
    ...
    if (response['action'] == 'generateCode'){
        ...
        if (current_attempt_id < NUM_ATTEMPTS && !win){
            ...
            win? alert("GG! You win. Click OK to see result, and play again.") // won!!!
            : alert("Uh Oh, Click OK to see result, and try again!");          // lost!!!
            //initGameBoard();
        }
    }
}
